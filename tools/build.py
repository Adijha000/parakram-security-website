...
#intro.open .ipt{transform:translateY(-101%)}#intro.open .ipb{transform:translateY(101%)}#intro.open .igrid,#intro.open .ic2,#intro.open .it,#intro.open .ibar,#intro.open .skip2{opacity:0;transition:opacity .45s}
...
<div class="fb"><span>© 2026 Parakram Security India Pvt. Ltd. All rights reserved.</span><span class="fl"><a href="privacy.html">Privacy Policy</a><a href="terms.html">Terms of Use</a><span>Website by <a class="by" href="https://aibootstrapper.com" target="_blank" rel="noopener">AIBOOTSTRAPPER</a></span></span></div></div></footer>
