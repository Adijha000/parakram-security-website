...
<div class="pil">
<div class="pl rv"><div class="big">9+</div><h3>Years of Experience</h3><p>A professionally managed security company operating since 2017.</p></div>
<div class="pl rv"><div class="big">1,500+</div><h3>Trained &amp; Verified Personnel</h3><p>Disciplined recruitment and rigorous training for every guard.</p></div>
<div class="pl rv"><div class="big">100%</div><h3>Customized Solutions</h3><p>Services designed around your site, your risk and your operations.</p></div></div>
...
const m=`Hello Parakram Security, I'd like a security plan.%0A%0A*Services:* ${sv}%0A*Site type:* ${v('site')}%0A*Team size:* ${v('g')}%0A*Coverage:* ${v('sh')}%0A*Name:* ${pn.value}%0A*Phone:* ${pp.value}%0A*Location:* ${pc.value}`;open(`https://wa.me/${PH}?text=${m}`,'_blank')}})();
