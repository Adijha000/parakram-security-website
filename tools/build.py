...
/* phones: tapping triggers :hover/:focus-within, so force the drawer submenu into flow */
@media(max-width:1180px){
.dd:hover .menu,.dd:focus-within .menu,.dd .menu,.dd.o .menu{position:static!important;left:auto!important;right:auto!important;top:auto!important;transform:none!important;width:100%!important;min-width:0!important;max-width:none!important;box-shadow:none!important;border:0!important;border-radius:12px!important;margin:8px 0!important;flex:0 0 100%}
.dd:not(.o) .menu,.dd:not(.o):hover .menu,.dd:not(.o):focus-within .menu{display:none!important}
.dd.o .menu{display:block!important;opacity:1!important;visibility:visible!important;overflow:visible}
.dd .mg{display:block!important;padding:6px!important}
...
/* phone header: larger logo */
@media(max-width:980px){
.nav{height:62px!important}header.sh .nav{height:62px!important}
nav{top:62px!important}header.sh nav{top:62px!important}
.brand{gap:10px}.brand img{height:46px!important;width:46px!important}
.brand b{font-size:17.5px!important;letter-spacing:.05em}.brand small{font-size:8px!important;letter-spacing:.14em!important}
.subnav{top:62px!important}main section[id]{scroll-margin-top:34px}
}
@media(max-width:380px){.brand img{height:42px!important;width:42px!important}.brand b{font-size:15.5px!important}.brand small{display:none!important}}
</style>
</head>
<body>
...
<div><a class="brand" href="/" aria-label="Parakram Security India home" style="margin-bottom:18px"><img src="logo.png" alt="" style="height:64px"><div><b style="color:#fff">PARAKRAM</b><small style="color:#aab0d6">SECURITY INDIA PVT. LTD.</small></div></a><p style="font-size:14.5px;max-width:320px">We aim to provide you with a life with full protection.</p></div>
...
document.querySelector('.brand').addEventListener('click',e=>{if(location.pathname!=='/'&&location.pathname!=='/index.html')return;e.preventDefault();lenis?lenis.scrollTo(0,{duration:1.3}):scrollTo({top:0,behavior:'smooth'});if(location.hash)history.replaceState(null,'',location.pathname)});
