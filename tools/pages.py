...
for slug,name,ic,im,pos,lead,short,what,where,faqs in SERV:
    ...
    banner=pbn([('Services','/services'),(nm,None)],nm.replace(' Security',' <em>Security</em>'),lead,img(im if im!='hero' else 'hero-portrait'),pos,BTN('Get a Plan →','#getplan')+BTN('Talk to Us','/contact','btn-o'),['Trained and verified','Available 24/7','Customized to your site'])
...
def careers_page():
    ...
    o+=f'<section class="blk"><div class="wrap">{sech("Life at Parakram","Discipline, training and teamwork.","Our people train, serve and grow together.")}<div class="mos rv"><div class="big"><img src="{img("training")}" alt="Parakram personnel in training" loading="lazy"><b>Rigorous training</b></div><div><img src="{img("operations")}" alt="Parakram guard on duty" loading="lazy"><b>On duty</b></div><div><img src="{img("about")}" alt="Parakram security officer" loading="lazy"><b>Professional presence</b></div><div><img src="{img("hero-portrait")}" alt="Parakram security officer" loading="lazy" style="object-position:50% 10%"><b>Verified personnel</b></div><div><img src="{img("training")}" alt="Parakram team" loading="lazy" style="object-position:20% 30%"><b>One team</b></div></div></div></section>'
